                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        gap: 12,
                        background: checked ? '#191207' : '#0a0a0a',
                        border: `1px solid ${checked ? '#6e4a1c' : '#1f1f1f'}`,
                        borderRadius: 8,
                        padding: '12px 14px',
                        cursor: 'pointer',
                        textAlign: 'left',
...
function PillList({
  ...
  const bg = warning ? '#150f05' : muted ? '#0f0f0f' : '#141414';
  const border = warning ? '#473012' : muted ? '#1f1f1f' : '#262626';
